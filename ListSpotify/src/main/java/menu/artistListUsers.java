...
@WebServlet(urlPatterns = {"/artistListUsers"})
public class artistListUsers extends HttpServlet {
    @Override
    ...
    public static void showTopArtists(HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                writer.println("<td class=\"action-column\">");
                writer.println("</td>");
                writer.println("</tr>");
                rowNumber++;
            }
        ...
        writer.println("<a href=\"MainUsers\" class=\"btn primary\">Back to Main Menu</a>");
        writer.println("</div>");
        writer.println("</div>");
        writer.println("</body>");
        writer.println("</html>");
