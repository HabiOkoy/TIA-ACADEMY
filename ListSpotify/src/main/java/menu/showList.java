...
public class showList extends HttpServlet {
    ...
    public static void showAllRecord(HttpServletResponse resp) throws IOException {
        ...
        writer.println("<th colspan=\"2\">Action</th>");
        writer.println("</tr>");
        writer.println("</thead>");
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                writer.println("<td><a href=\"editList?name=" + name + "&artist=" + artist + "&release_date=" + releaseDate + "&length=" + length + "&popularity=" + popularity + "\" class=\"button success\">Edit</a></td>");
                writer.println("<td><a href=\"deleteList?name=" + name + "&artist=" + artist + "&release_date=" + releaseDate + "&length=" + length + "&popularity=" + popularity + "\" class=\"button delete\">Delete</a></td>");
                writer.println("</tr>");
                rowNumber++;
            }
        ...
        writer.println("</div>");
        writer.println("<br>");
        writer.println("<a href=\"Main\" class=\"button primary\">Back to Main Menu</a>");
        writer.println("</div>");
        writer.println("</body>");
        writer.println("</html>");
        writer.flush();
